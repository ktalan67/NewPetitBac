 ...
 */
final class Version20200405011108 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE liste_amis (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, amis LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_BEB527B261220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE liste_amis ADD CONSTRAINT FK_BEB527B261220EA6 FOREIGN KEY (creator_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE liste_amis DROP FOREIGN KEY FK_BEB527B261220EA6');
        ...
        $this->addSql('DROP TABLE liste_amis');
